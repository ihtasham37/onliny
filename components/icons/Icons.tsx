...
// Using a central object for icons makes them easy to manage and reuse.
...
export const Icons = {
  ...
  getApp: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
  ...
  telegram: (props: React.SVGProps<SVGSVGElement>) => (
     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M21.198 2.433a2.242 2.242 0 0 0-1.022.215l-18.6 8.2a2.25 2.25 0 0 0 .12 4.152l4.89 1.54 1.83 5.63a2.25 2.25 0 0 0 4.08-.2l2.67-3.9 4.6 3.39a2.25 2.25 0 0 0 3.53-1.84l3.14-15.6a2.25 2.25 0 0 0-5.238-1.587z" />
     </svg>
  ),
